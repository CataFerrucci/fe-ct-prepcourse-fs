...
var usuarioCuenta = new Usuario('ejemploUsuario', 'Pepito', 'pepito123@email.com', 'codigo');
console.log(usuarioCuenta.saludar());
...
var usuario = new Usuario('ejemploUsuario', 'Pepito', 'pepito123@email.com', 'codigo');
...
var str = agregarStringInvertida();
str = "hola";
